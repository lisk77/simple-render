...
fn absolute_child_rect(child: &Rect, content: Bounds, fonts: &mut FontCtx) -> (Bounds, Size) {
...
fn axis_length(element: &Rect, direction: Direction) -> Length {
    match direction {
...
fn cross_length(element: &Rect, direction: Direction) -> Length {
    match direction {
...
fn resolve_axis_length(element: &Rect, direction: Direction, available: u32, fit: u32) -> u32 {
...
fn resolve_cross_length(element: &Rect, direction: Direction, available: u32, fit: u32) -> u32 {
    let (min, max) = match direction {
...
fn constrain_axis(size: u32, element: &Rect, direction: Direction) -> u32 {
    let (min, max) = match direction {
        Direction::Row => (element.min_width, element.max_width),
        Direction::Column => (element.min_height, element.max_height),
    };
...
fn constrain_cross(size: u32, element: &Rect, direction: Direction) -> u32 {
    let (min, max) = match direction {
        Direction::Row => (element.min_height, element.max_height),
        Direction::Column => (element.min_width, element.max_width),
    };
...
fn resolve_length(length: Length, available: u32, fit: u32, min: u32, max: Option<u32>) -> u32 {
...
fn constrain_dimension(size: u32, min: u32, max: Option<u32>) -> u32 {
